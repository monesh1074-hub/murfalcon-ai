...
export default function ScorecardScreen() {
  ...
  return (
    <div className="min-h-[100dvh] pt-24 pb-12 bg-zinc-950 flex flex-col items-center justify-center px-4 md:px-8 overflow-hidden relative font-sans">
      ...
      <div className="max-w-[1000px] w-full bg-white/[0.02] border border-white/10 rounded-[40px] p-8 md:p-12 backdrop-blur-3xl shadow-[0_20px_60px_rgba(0,0,0,0.5)] relative z-10 flex flex-col xl:flex-row gap-12 xl:gap-16 items-center xl:items-stretch">
        ...
        <div className="w-full xl:w-1/2 flex flex-col items-center justify-center text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-400 tracking-tight leading-tight mb-2">
            Interview Complete!
          </h2>
        ...
        <div className="w-full xl:w-1/2 flex flex-col justify-center">
            ...
            <div className="text-sm md:text-[15px] text-zinc-300 leading-relaxed font-light">
              {scores.tips || (
                <>
                  ...
                  <br /><br />
                  Your communication bandwidth analyzing {currentRole} parameters was highly effective. Technical bounds were met accurately.
                  <br /><br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full mt-auto">
            <button
              ...
              className="group relative flex-1 bg-violet-600 hover:bg-violet-500 py-4 px-6 rounded-2xl transition-all duration-300 text-sm font-bold tracking-widest uppercase overflow-hidden shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:shadow-[0_0_30px_rgba(168,85,247,0.5)] hover:-translate-y-0.5"
            >
